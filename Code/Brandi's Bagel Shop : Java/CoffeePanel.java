...
//The CoffeePanel class allows the use to select coffee.
...
public class CoffeePanel extends JPanel {
    ...
    private final JRadioButton noCoffee; // To select no coffee.
    private final JRadioButton regularCoffee; // To select regular coffee.
    private final JRadioButton decafCoffee; // To select decaf coffee.
    private final JRadioButton cappuccino; // To select cappuccino
    private final ButtonGroup bg; // Radio button group
